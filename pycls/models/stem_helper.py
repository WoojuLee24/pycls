...
class ResStemCifarNoBn(Module):
    ...
    def __init__(self, w_in, w_out):
        super(ResStemCifarNoBn, self).__init__()
        self.conv = conv2d(w_in, w_out, 3)
        self.af = activation()
...
class ResStemCifarSMAvgEntire(Module):
    """ResNet stem for CIFAR: 3x3, BN, AF."""

    def __init__(self, w_in, w_out):
        super(ResStemCifarSMAvgEntire, self).__init__()
        self.conv = conv2d(w_in, w_out, 3)
        self.bn = norm2d(w_out)
        self.af = activation()
...
class ResStemCifarSMDcEntire(Module):
    """ResNet stem for CIFAR: 3x3, BN, AF."""

    def __init__(self, w_in, w_out):
        super(ResStemCifarSMDcEntire, self).__init__()
        self.conv = conv2d(w_in, w_out, 3)
        self.bn = norm2d(w_out)
        self.af = activation()
...
class ResStemCifarSurroundDilationConvDcEntire(Module):
    """ResNet stem for CIFAR: 3x3, BN, AF."""

    def __init__(self, w_in, w_out):
        super(ResStemCifarSurroundDilationConvDcEntire, self).__init__()
        self.conv = conv2d(w_in, w_out, 3)
        self.bn = norm2d(w_out)
        self.e = SurroundDilation(w_out, w_out, 3, stride=1, groups=w_out, bias=False)
...
class ResStemCifarCenterSurroundConvDcEntire(Module):
    """ResNet stem for CIFAR: 3x3, BN, AF."""

    def __init__(self, w_in, w_out):
        super(ResStemCifarCenterSurroundConvDcEntire, self).__init__()
        self.conv = conv2d(w_in, w_out, 3)
        self.bn = norm2d(w_out)
        self.e = CenterSurround(w_out, w_out, 5, stride=1, groups=w_out)
        self.af = activation()
...
class ResStemCifarSurroundDivideConvDcEntire(Module):
    """ResNet stem for CIFAR: 3x3, BN, AF."""
...
class ResStemCifarSurroundDivideConvFcEntire(Module):
    """ResNet stem for CIFAR: 3x3, BN, AF."""
...
class ResStemCifarDivide5x5ConvDcx2Entire(Module):
    """ResNet stem for CIFAR: 3x3, BN, AF."""

    def __init__(self, w_in, w_out):
        super(ResStemCifarDivide5x5ConvDcx2Entire, self).__init__()
        self.conv = conv2d(w_in, w_out, 3)
        self.bn = norm2d(w_out)
        self.e = EndstoppingDivide5x5(w_out, w_out, 5, stride=1, groups=w_out)
        self.e2 = EndstoppingDivide5x5(w_out, w_out, 5, stride=1, groups=w_out)
        self.af = activation()
...
class ResStemCifarSigmoid5x5ConvDcEntire(Module):
    ...
    def __init__(self, w_in, w_out):
        super(ResStemCifarSigmoid5x5ConvDcEntire, self).__init__()
        self.conv = conv2d(w_in, w_out, 3)
        self.bn = norm2d(w_out)
        self.e = EndstoppingSigmoid(w_out, w_out, 5, stride=1, groups=w_out)
        self.af = activation()
...
class ResStemCifarSlopeTanh5x5ConvDcEntire(Module):
    """ResNet stem for CIFAR: 3x3, BN, AF."""

    def __init__(self, w_in, w_out):
        super(ResStemCifarSlopeTanh5x5ConvDcEntire, self).__init__()
        self.conv = conv2d(w_in, w_out, 3)
        self.bn = norm2d(w_out)
        self.e = EndstoppingSlopeTanh(w_out, w_out, 5, stride=1, groups=w_out)
        self.af = activation()
...
class ResStemCifarSlopeTanh25x5ConvDcEntire(Module):
    """ResNet stem for CIFAR: 3x3, BN, AF."""

    def __init__(self, w_in, w_out):
        super(ResStemCifarSlopeTanh25x5ConvDcEntire, self).__init__()
        self.conv = conv2d(w_in, w_out, 3)
        self.bn = norm2d(w_out)
        self.e = EndstoppingSlopeTanh2(w_out, w_out, 5, stride=1, groups=w_out)
        self.af = activation()
...
class ResStemCifar7x7ConvFixedSmDcEntireNoaf(Module):
    """ResNet stem for CIFAR: 3x3, BN, AF."""

    def __init__(self, w_in, w_out):
        super(ResStemCifar7x7ConvFixedSmDcEntireNoaf, self).__init__()
        self.conv = conv2d(w_in, w_out, 7)
        self.bn = norm2d(w_out)
        self.af = activation()
        self.e = CompareFixedSM(w_out, w_out, 5, stride=1, groups=w_out)
...
class ResStemCifar7x7ConvCompareFixedLPNoaf(Module):
    """ResNet stem for CIFAR: 3x3, BN,AF."""

    def __init__(self, w_in, w_out):
        super(ResStemCifar7x7ConvCompareFixedLPNoaf, self).__init__()
        self.conv = conv2d(w_in, w_out, 7)
        self.bn = norm2d(w_out)
        self.af = activation()
        self.e = BlurPool(w_out, filt_size=3, stride=1)
...
class ResStemCifar7x7ConvCompareFixedHPNoaf(Module):
    """ResNet stem for CIFAR: 3x3, BN, AF."""

    def __init__(self, w_in, w_out):
        super(ResStemCifar7x7ConvCompareFixedHPNoaf, self).__init__()
        self.conv = conv2d(w_in, w_out, 7)
        self.bn = norm2d(w_out)
        self.af = activation()
        self.e = CompareFixedHP(w_out, w_out)
...
class ResStemCifarConvFixedSmDcEntireNoaf7x7Conv(Module):
    """ResNet stem for CIFAR: 3x3, BN, AF."""
...
class ResStemMaxBlurPool(Module):
    ...
    def __init__(self, w_in, w_out):
        super(ResStemMaxBlurPool, self).__init__()
...
class ResStemFixSMEntireAf(Module):
    """ResNet stem for ImageNet: 7x7, BN, AF, MaxPool."""

    def __init__(self, w_in, w_out):
        super(ResStemFixSMEntireAf, self).__init__()
        self.conv = conv2d(w_in, w_out, 7, stride=2)
        self.bn = norm2d(w_out)
        self.af = activation()
        self.e = CompareFixedSM(w_out, w_out, 5, stride=1, groups=w_out)
